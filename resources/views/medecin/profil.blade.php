                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        <h3 class="user-name m-t-0 mb-0">{{ $medecin->user->name }}</h3>
                                        <div class="staff-id">Doctor ID : {{ $medecin->N_professionel }}</div>
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <ul class="personal-info">
                                        <li>
                                            ...
                                            <span class="text"><a href="tel:{{ $medecin->tel }}">{{ $medecin->tel }}</a></span>
                                        </li>
                                        <li>
                                            <span class="title">Email:</span>
                                            <span class="text"><a href="mailto:{{ $medecin->user->email }}">{{ $medecin->user->email }}</a></span>
                                        </li>
                                        <li>
                                            <span class="title">Address:</span>
                                            <span class="text">{{ $medecin->adress }}</span>
                                        </li>
                                        <li>
                                            <span class="title">Specialité:</span>
                                            <span class="text text-uppercase">{{ $medecin->specialite }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
