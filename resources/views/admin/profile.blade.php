    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-5 col-6 text-right m-b-30">
                <a href="edit-profile.html" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Modifier Profile</a>
            </div>
        </div>
                                ...
                                <div class="col-md-7">
                                    <ul class="personal-info">
                                        <li>
                                            ...
                                            <span class="text"><a href="">{{$admin->admin->tele }}</a></span>
                                        </li>
                                        <li>
                                            <span class="title">Email:</span>
                                            <span class="text"><a href=""><span class="__cf_email__" data-cfemail="97f4e5fee4e3fef9f6f0e5f8e1f2e4d7f2eff6fae7fbf2b9f4f8fa">{{$admin->email }}</span></a></span>
                                        </li>
                                        <li>
                                            <span class="title">Date Naissance:</span>
                                            <span class="text">{{$admin->admin->date_naissance }}</span>
                                        </li>
                                        <li>
                                            <span class="title">Address:</span>
                                            <span class="text">{{$admin->admin->adresse }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
