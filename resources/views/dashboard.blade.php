            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <form id="profil-form" action="{{ route('profile.edit') }}" method="GET" style="display: none;">
                            @csrf
                        </form>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        <li>
                            <a href="" class="nav-link  nav1" id="home"><i class="fa fa-dashboard"></i>
                        ...
                        <li>
                            <a href="patients.html" class="nav-link nav1" id="patients"><i
                                    class="fa fa-wheelchair"></i>
                                <span>Patients</span></a>
                        </li>
                        <li>
                            <a href="appointments.html" class="nav-link nav1"><i class="fa fa-calendar"></i>
                                <span>Appointments</span></a>
                        </li>
                        <li>
                            <a href="schedule.html" class="nav-link nav1"><i class="fa fa-calendar-check-o"></i>
