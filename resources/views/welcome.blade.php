    ...
    <main>
                            ...
                            <div class="row align-items-center no-gutters">
                                ...
                                <div class="col-lg-5">
                                    <div class="dept_thumb">
                                        <img src="{{ asset('sitePublic/assets/img/gallery/department_man.png') }}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="testimonial-caption ">
                            ...
                            <div class="testimonial-founder d-flex align-items-center justify-content-center">
                                <div class="founder-img">
                                    <img src="{{ asset('sitePublic/assets/img/gallery/Homepage_testi.png') }}"
                                        alt="">
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('sitePublic/assets/img/gallery/team3.png') }}" alt="">
                            </div>
                            <div class="team-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('sitePublic/assets/img/gallery/team1.png') }}" alt="">
                            </div>
                            <div class="team-caption">
        ...
        <div class="contact-form-main">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="submit-info">
                                            <button class="btn" type="submit">Submit Now <i
            ...
            <div class="from-left d-none d-lg-block">
                <img src="{{ asset('sitePublic/assets/img/gallery/contact_form.png') }}" alt="">
            </div>
        </div>
        <!-- Contact form End -->
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="{{ asset('sitePublic/assets/img/gallery/blog1.png') }}" alt="">
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Health</span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="{{ asset('sitePublic/assets/img/gallery/blog2.png') }}" alt="">
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Checkup</span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="{{ asset('sitePublic/assets/img/gallery/blog3.png') }}" alt="">
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Operation</span>
